...
<table border="0">
<tr><td>Your email address:</td><td style="width:40px"></td><td><input type="text" name="email" id="email" value="<?php echo $_SESSION["contact"]["email"]; ?>" style="width:300px" onblur="checkEmail()" /></td><td style="width:10px"></td><td id="emailmsg" style="color:#f00"></td></tr>
