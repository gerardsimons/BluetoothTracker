...
class PxColor
{
    ...
    //with specified delta value (-255 to 255) and returns new hex value
    public static function ChangeBrightness($color, $delta)
    {
    ...
    public static function NamedColorToHex($name, $retArray=false)
    {
        $colors = array(
