    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        switch (SensorType) {
            case Sensor.TYPE_GRAVITY:
                ...
                m_Norm_Gravity = (float) Math.sqrt(m_NormGravityVector[0] * m_NormGravityVector[0] + m_NormGravityVector[1] * m_NormGravityVector[1]
                        + m_NormGravityVector[2] * m_NormGravityVector[2]);
            ...
            case Sensor.TYPE_MAGNETIC_FIELD:
                ...
                m_Norm_MagField = (float) Math.sqrt(m_NormMagFieldValues[0] * m_NormMagFieldValues[0] + m_NormMagFieldValues[1] * m_NormMagFieldValues[1]
                        + m_NormMagFieldValues[2] * m_NormMagFieldValues[2]);
        ...
        if (m_NormGravityVector != null && m_NormMagFieldValues != null) {
            ...
            if (m_Norm_Gravity * m_Norm_MagField * norm_East < 0.1f) { // Typical values are  > 100.
                ...
                float M_dot_G = (m_NormGravityVector[0] * m_NormMagFieldValues[0] + m_NormGravityVector[1] * m_NormMagFieldValues[1] + m_NormGravityVector[2]
